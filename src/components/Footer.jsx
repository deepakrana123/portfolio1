      ...
      <div className="container-xl">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span
                className="text-[0.9375rem] font-bold leading-none shimmer-text"
            ...
            <div className="grid grid-cols-2 gap-y-3 gap-x-4">
              {navLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="text-[0.875rem] text-slate-500 hover:text-slate-300 transition-colors duration-200 leading-none"
                >
                  {link.label}
                </a>
              ))}
          ...
          <div>
            ...
            <motion.a
              href="#contact"
              className="btn-primary text-[0.875rem] inline-flex"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-700 text-xs flex items-center gap-1.5">
            Built with <Heart size={10} className="text-pink-500/60" /> using React, Three.js &amp; Tailwind
          </p>
          <motion.button
            onClick={scrollToTop}
